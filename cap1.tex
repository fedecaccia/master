...
Notar que los últimos sistemas presentados resuelven sistemas de ecuaciones de forma monolítica, y por lo tanto permiten incluir estrategias prohibidas al método \textit{Dirichlet-to-Neumann}.
