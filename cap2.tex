...
\begin{tikzpicture}[
  ...
  % t->t+dt
  \node [draw,rectangle, fill=white, text width=2.5cm, align=center] at (0,-5em) (actualizar) {\scriptsize $t_{coup,j} = t_{coup,j} + \Delta t$};
  
  
  % t<tf
  \node [draw,rectangle, fill=white, text width=1.8cm, align=center, below=1em of actualizar] (minor) {\scriptsize $t_{coup} < t_{coup,final}?$};
...
%~ 
  ...
  % Continue order
  \node at($(actualizar.west) - (12.1em,0em)$) (c23) {};
  \node at($(c23) + (0em,26.0em)$) (c24) {};
  \node at($(c24) + (13.5em,0em)$) (c25) {};
  \node at($(c25) - (0em,2.em)$) (c26) {};
  \draw[arrow1,dashed] (actualizar.west) -- (c23.center) -- (c24.center) -- (c25.center) -- (c26.center);
