...
ya que el subsistema incluye porciones de cañería a la entrada y a la salida.
Se trabaja con modelos con dos fluidos distintos, para evaluar alguna posible diferencia en la dinámica del comportamiento.
El primer fluido considerado es agua, y sus parámetros son: $\rho_0=10^3$ $Kg/m^3$ a la temperatura de referencia $T_{ref}$,
$\mu=6\cdot 10^{-4}$ $Kg/ms$, $c_p=4184$ $J/KgK$ y 
$k=0.64$ $W/mK$ y $\beta=0.44\cdot10^{-3}K^{-1}$.
El segundo fluido estudiado es deuterio líquido, y sus parámetros son:
...
Se considera que el fluido tiene una fuente interna $f_0$ en la cavidad, cuyo valor varía en diferentes modelos,
...
Los parámetros de los fluidos de trabajo son los mismos que los comentados en la descripción del primer subsistema.
La evolución de las variables de presión $p$, caudal $Q$ y temperatura $T$ se calcula mediante un código cero-dimensional escrito para este propósito,
...
También se utiliza la hipótesis de que los términos provenientes de los balances de energía con derivada temporal son despreciables frente a los términos que sobreviven en \ref{eq-intercambiador},
...
\begin{table}[h!]
  ...
  \begin{tabular}{ c c c c c c c } 
      \hline
      \multicolumn{1}{c}{$f_0$ $[W/m^3]$} & \multicolumn{1}{c}{$H / \Delta z$} & \multicolumn{1}{c}{$Ri$} & \multicolumn{1}{c}{$\Delta T_{media}$ $[K]$} & \multicolumn{1}{c}{$Q$$[m^3/s]$}& \multicolumn{1}{c}{$\Delta p$ $[Pa]$} \\ \hline
      \multirow{3}{*}{$4\cdot10^4$} & $1$ & 0.8 & 1.1 & $1.159 \cdot 10^{-3}$ & 3765 \\
                         & $4$ & 0.8 & 1.2 & $1.160 \cdot 10^{-3}$ & 3765 \\
                         & $10$ & 0.8 & 1.1 & $1.162 \cdot 10^{-3}$ & 3765 \\ \hline
      \multirow{3}{*}{$4\cdot10^5$} & $1$ & 7.1 & 8.2 & $1.159 \cdot 10^{-3}$ & 3765 \\
                         & $4$ & 7.1 & 8.2 & $1.160 \cdot 10^{-3}$ & 3757 \\
                         & $10$ & 7.2 & 8.4 & $1.162 \cdot 10^{-3}$ & 3757 \\ \hline
      \multirow{3}{*}{$4\cdot10^6$} & $1$ & 72.1 & 82.4 & $1.159 \cdot 10^{-3}$ & 3757 \\
...
\begin{table}[h!]
  ...
  \begin{tabular}{ c c c c c c c } 
      ...
      \multirow{3}{*}{$4\cdot10^2$} & $1$ & 1.6 & $6\cdot10^{-2}$ & $1.158 \cdot 10^{-3}$ & 615 \\
                         & $4$ & 1.3 & $5\cdot10^{-2}$ & $1.159 \cdot 10^{-3}$ & 615 \\
                         & $10$ & 1.3 & $5\cdot10^{-2}$ & $1.160 \cdot 10^{-3}$ & 615 \\ \hline
      \multirow{3}{*}{$4\cdot10^3$} & $1$ & 26.4 & 0.3 & $1.159 \cdot 10^{-3}$ & 613 \\
                         & $4$ & 25.9 & 0.3 & $1.160 \cdot 10^{-3}$ & 613 \\
                         & $10$ & 26.4 & 0.3 & $1.173 \cdot 10^{-3}$ & 613 \\ \hline
      \multirow{3}{*}{$4\cdot10^4$} & $1$ & 89.9 & 3.4 & $1.152 \cdot 10^{-3}$ & 600 \\
