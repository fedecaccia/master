...
\begin{table}[h]
  ...
  \begin{tabular}{ l r r } \hline
      Método no lineal & Evaluaciones totales & Tiempo total [s]\\ \hline %\hline
      Picard & 100 & 2017 \\ %\hline            
      Punto fijo & 111 & 1619  \\ \hline      
   \end{tabular}
...
La mayoría de los métodos fue incapaz de completar el ciclo de quemado asegurando la convergencia fuerte de los resultados en cada paso de evolución.
