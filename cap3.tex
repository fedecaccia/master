...
o bien uno con condición de tipo \textit{Neumann} y otro con condición de tipo \textit{Dirichlet}.
...
Como el modelo es ficticio, el diámetro y la cantidad de pines asumen valores arbitrarios.
