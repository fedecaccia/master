...
$P$ indica el órden de extrapolación para $\bar{x}_n$ o para $\mathbb{B}_n$ utilizado en cada esquema.
...
Conforme a la estrategia de resolución descripta en la sección \ref{1:abordaje},
...
En la Figura \ref{net_linear_its} se pueden observar la cantidad de iteraciones requeridas por diferentes métodos para la convergencia de resultados
...
El método de \textit{Newton-Raphson} y el método de la \textit{secante} requieren solo una iteración, debido a que los sistemas de cálculo son lineales.
Sin embargo
