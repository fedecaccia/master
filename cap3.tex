...
\label{eq-nt}
\end{equation}
donde $\bar{\phi}$ es un vector con el valor del flujo neutrónico a diferentes grupos de energía en cada punto\footnote{
...
$\Sigma$ es la matriz de secciones eficaces que contiene valores asociados a diferentes reacciones para diferentes grupos de energía en cada punto de cálculo,
...
\label{eq-sigma}
\end{equation}
El valor de la potencia $P_i$ en cada punto de cálculo $i$ puede obtenerse a partir del flujo neutrónico \cite{lamarsh} obtenido en ese punto de la siguiente manera:
...
$\phi_{i,j}$ es la componente del flujo neutrónico en la punto $i$ y el grupo de energía $j$.
