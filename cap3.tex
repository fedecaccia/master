...
\label{eq-nt}
\end{equation}
donde $\bar{\phi}$ es un vector con el valor del flujo neutrónico a diferentes grupos de energía integrado en las celdas de cálculo del reactor,
$\Sigma$ es la matriz de secciones eficaces que contiene valores asociados a diferentes reacciones para diferentes grupos de energía en cada celda de cálculo,
...
\label{eq-sigma}
\end{equation}
El valor de la potencia $P_i$ en cada celda de cálculo $i$ puede obtenerse a partir del flujo neutrónico \cite{lamarsh} obtenido en esa celda de la siguiente manera:
...
$\phi_{i,j}$ es la componente del flujo neutrónico en la celda $i$ y el grupo de energía $j$.
